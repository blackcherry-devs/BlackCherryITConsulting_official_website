...
export const Notification = ({
  ...
  return (
    <motion.div
      ...
      className="p-4 w-80 flex items-start rounded-lg gap-3 text-sm font-medium shadow-[0_10px_40px_rgba(0,0,0,0.5)] text-white bg-green-600 fixed z-[200] bottom-6 right-6"
    >
      <FiAlertCircle className="text-3xl min-w-8 min-h-8 p-1.5 rounded-full bg-white text-green-600 shadow" />
