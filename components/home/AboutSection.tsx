...
export default function AboutSection() {
  ...
  return (
    <section id="servicios" ref={containerRef} className="w-full pt-20 min-[600px]:pt-32 pb-56 min-[600px]:pb-48 px-6 min-[600px]:px-[var(--gutter-width)] relative overflow-hidden bg-[#1F1F1F]">
      <GridLines />
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 relative z-10 min-h-[400px]">
        <div className="w-full lg:w-1/3 pl-0 lg:pl-4 flex flex-col justify-between">
          <div>
            <span className="font-headline font-black text-white text-[10px] min-[600px]:text-xs tracking-[0.3em] uppercase">01 / SERVICIOS</span>
        ...
        <div className="w-full lg:w-2/3 flex flex-col justify-start">
          <p ref={textRef} className="font-headline font-light leading-snug relative z-[110] pr-0 lg:pr-4 text-lg min-[600px]:text-2xl">
