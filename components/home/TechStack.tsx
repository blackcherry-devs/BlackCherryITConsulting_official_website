  ...
  return (
    ...
    >
      ...
      <div className="w-full min-h-[500px] lg:min-h-[600px] relative z-10 flex flex-col lg:flex-row items-stretch">
        ...
        <div className="lg:w-[65%] absolute lg:relative inset-0 lg:inset-auto z-0 lg:z-10 flex gap-4 lg:gap-8 items-start h-full lg:h-[700px] overflow-hidden px-[var(--gutter-width)] lg:px-0 lg:pr-4 py-10 lg:py-20 w-full justify-center min-[600px]:justify-start">
          {/* Carousel 1 (Scrolls UP) */}
          <div className="flex-1 lg:flex-[1.4] relative h-full lg:h-[600px] overflow-hidden bg-transparent lg:-mt-20 flex flex-col items-center min-[600px]:items-start">
            <div className="flex flex-col gap-0 py-0 animate-scroll-up w-full items-center min-[600px]:items-start">
              ...
              {[...stackTop, ...stackTop].map((tech, i) => (
                <div key={i} className="h-[100px] lg:h-[150px] flex items-center justify-center min-[600px]:justify-start w-full">
          ...
          <div className="flex-1 relative h-full lg:h-[600px] overflow-hidden bg-transparent lg:mt-20 hidden min-[600px]:block">
