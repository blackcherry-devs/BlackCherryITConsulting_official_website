...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-black text-white relative overflow-hidden border-t border-white/5 pt-20">
      ...
      {/* Main Footer Content */}
      <div className="relative z-10 px-[7rem] pb-20 pointer-events-none">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 pointer-events-auto">
          {/* Brand Block */}
        ...
        <div className="mt-40 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 pointer-events-auto">
          <span className="font-headline text-[10px] text-white/20 uppercase tracking-[0.5em]">© 2026 BLACKCHERRY IT CONSULTING. TODOS LOS DERECHOS RESERVADOS.</span>
          <div className="flex gap-8">
            <button 
              onClick={openPrivacy}
              className="font-headline text-[10px] text-white/20 hover:text-white/40 uppercase tracking-[0.2em] cursor-pointer outline-none"
            >
