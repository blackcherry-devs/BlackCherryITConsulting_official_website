    ...
    <>
      ...
      <div className="fixed top-0 left-16 lg:left-[var(--gutter-width)] right-0 lg:right-[var(--gutter-width)] h-16 lg:h-20 z-[105] flex pointer-events-none">
        ...
        >
          ...
          {!isDarkTheme && <div className="absolute left-0 top-0 bottom-0 w-[1.3px] bg-gray-500/20 mix-blend-difference pointer-events-none"></div>}
      ...
      <AnimatePresence>
        {isMobileMenuOpen && <LinksOverlay setActive={setIsMobileMenuOpen} navLinks={navLinks} pathname={pathname} />}
      </AnimatePresence>
  ...
  return (
    <nav id="mobile-nav" aria-label="Menú móvil" className="fixed right-2 top-2 z-[125] h-[calc(100dvh-16px)] w-full max-w-[min(450px,calc(100vw-16px))] overflow-hidden flex flex-col pointer-events-auto lg:hidden">
      <div className="p-8 pb-4">
        ...
        >
          <img src="/logo-blackcherry-footer.png" alt="BlackCherry Logo" className="w-40 min-[600px]:w-48 h-auto brightness-0 invert" />
        </motion.div>
      </div>
        ...
        <div className="flex gap-6">
          {SOCIAL_CTAS.map((l, idx) => (
            <motion.a
              ...
              initial={{ opacity: 0, y: 8 }}
              animate={{ opacity: 1, y: 0, transition: { delay: 1.2 + idx * 0.1 } }}
